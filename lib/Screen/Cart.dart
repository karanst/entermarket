...
class StateCart extends State<Cart> with TickerProviderStateMixin {
                      ...
                      child: Stack(
                        ...
                        children: [
                                ...
                                Container(
                                  ...
                                  child: FadeInImage(
                                    image: CachedNetworkImageProvider(
                                        cartList[index].productList![0].image.toString()),
                                    height: 110.0,
                                    width: 110.0,
                                    fit: BoxFit.fill,
                                    imageErrorBuilder:
                          ...
                          Container(
                            ...
                            decoration: boxDecoration(radius: 8,bgColor: Theme.of(context).colorScheme.primary,),
                            child: Center(
                              child: Text(
                                cartList[index].productList![0].store_name!,
                                style: Theme.of(context)
                                    .textTheme
                                    .bodySmall!
                                    .copyWith(
                                            ...
                                            onBtnSelected:  () async{
                                                    ...
                                                    if (selAddress == null ||
                                                     ...
                                                     if(result=="yes"){
                                                       ...
                                                       checkoutState!(() {
                                                         if(selTime!.toLowerCase().contains("collect")){
                                                           ...
                                                           print("temp charge here ${tempCharge} and ${delCharge}");
                                                     ...
                                                     var result = await Navigator.push(
                                                          ...
                                                          MaterialPageRoute(
                                                              builder: (BuildContext
                                                                  ...
                                                                  Payment(
                                                                      ...
                                                                      msg)));
                                                      if(result=="yes"){
                                                        print("checking delivery 1 ${delCharge}");
                                                        checkoutState!(() {
                                                          if(selTime!.toLowerCase().contains("collect")){
                                                            tempCharge =delCharge;
                                                            delCharge = 0;
                                                      ...
                                                      setSnackbar(
                                                          getTranslated(context,
                                                              'MIN_CART_AMT')!+"Minimum Order is ${MIN_ALLOW_CART_AMT}",
                                                          _checkscaffoldKey);
                                                    } else if (!deliverable) {
                                                      checkDeliverable();
                                                    } else
  ...
  stripePayment() async {
    setSnackbar("Not Available", _checkscaffoldKey);
  /*  context.read<CartProvider>().setProgress(true);
