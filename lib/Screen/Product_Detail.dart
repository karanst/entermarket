                                                ...
                                                child: Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        "Your cart contains item from ${sellerName}.Do you want to discard selection and add item from ${widget.model!.store_name}.",
                                                        style: TextStyle(
                                                            color: Colors.black,
                                                            fontSize: 12.0,
                                                            fontWeight:
  ...
  _shortDesc() {
    return widget.model!.shortDescription != null &&
        ...
        ? Padding(
            ...
            child: Html(data: widget.model!.shortDescription!)
            // Text(
