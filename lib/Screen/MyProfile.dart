...
class StateProfile extends State<MyProfile> with TickerProviderStateMixin {
  ...
  Future<DeleteAccountModel?> deleteAccount() async {
    var header = headers;
    var request = http.MultipartRequest('GET', Uri.parse('https://entemarket.com/app/v1/api/remove_user/$CUR_USERID'));
  ...
  _getDrawer() {
    return ListView(
      ...
      children: <Widget>[
        ...
        // _getDivider(),
        _getDrawerItem(getTranslated(context, 'DELETE_ACCOUNT')!, 'assets/images/pro_share.svg'),
        // CUR_USERID == "" || CUR_USERID == null ? Container() : _getDivider(),
        CUR_USERID == "" || CUR_USERID == null
            ? Container()
...
/*  _getDivider() {
  ...
  void onThemeChanged(String value, BuildContext ctx,) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
